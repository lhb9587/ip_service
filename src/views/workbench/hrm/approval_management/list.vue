<template>
  <div class="main-list">
    <div class="hrm-search">
      ...
      <el-select v-model="empStatus" @change="handleSearch" :style="{ width: inputWid(empStatus) }" size="small" filterable clearable placeholder="项目类型">
        <el-option
...
export default {
  ...
  data() {
    ...
    return {
      ...
      deptCodes: [],
      positionName: '',
      empStatus: '', // 在职状态 0=>离职员工，1=>正式员工，2=>实习员工，3=>兼职人员，4=>试用人员，5=>退休返聘
      userList: [], // 用户列表
      groupList: [], // 工作组列表
      positionsList: [],// 岗位列表
      // statusList: [
