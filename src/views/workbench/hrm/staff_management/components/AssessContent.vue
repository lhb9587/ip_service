    ...
    <div class="assess-div">
      <el-table
        ...
        <el-table-column
          ...
          label="考核要素">
          <template slot-scope="scope">
            <el-input type="textarea" v-model="scope.row.element" :placeholder="scope.row.elementPlaceholder"></el-input>
          </template>
        </el-table-column>
        <el-table-column
          prop="standard"
          label="考核标准">
          <template slot-scope="scope">
            <el-input type="textarea" v-model="scope.row.standard" :placeholder="scope.row.placeholder"></el-input>
          </template>
        </el-table-column>
        <el-table-column
          prop="weight"
  ...
  data() {
    return {
      ...
      defaultAssessContent: [
        { performType: 1, element: '', elementPlaceholder: '考核要素：由直属主管制定考核内容', standard: '', weight: 0 },
        { performType: 2, element: '', elementPlaceholder: '精神面貌、专业技能及知识、责任意识、沟通技能、团队合作等方面', standard: '', weight: 0 },
        { performType: 3, element: '', elementPlaceholder: '说明：非必填部分。直属上级根据考核期内整体工作情况体现其他奖惩项目', standard: '', weight: 0 }
      ]
    }
  },
  created() {
