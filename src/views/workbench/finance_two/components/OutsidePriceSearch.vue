              ...
              <div class="form-container">
                <el-form size="mini" label-width="120px" style="margin-top: 2px" :model="queryModuleData">
                  <el-form-item class="postInfo-container-item" label="客户:">
                    <el-select
                               v-model="queryModuleData['custId']" filterable remote clearable placeholder="请输入关键词"
                               :remote-method="(queryString)=>{
            remoteMethod(queryString, '','custId', '客户'); }">
                  ...
                  <el-form-item v-if="queryModuleData.caseTypeId == 30" label="变更类型" class="">
