...
<script>
  ...
  import {auditWorkHours, queryWorkHourTask, updateWorkHourTasker} from "../../../../api/caseList";
  ...
  export default {
    ...
    data() {
      return {
        ...
        tableDefaultList: [
          ...
          { title: '记录工时', value: 'time'},
          { title: '标准费率', value: 'criterionRate'},
        ],
        taskType: null,
        currentId: '',
        currentCaseId: '',
    ...
    methods: {
      ...
      queryList() {
        queryWorkHourTask({...this.listQuery, ...this.query, custName: undefined}).then(res => {
