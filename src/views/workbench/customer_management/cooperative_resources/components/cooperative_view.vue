                  ...
                  <el-row class="">
                    ...
                    <el-col :span="12">
                      <el-form-item label="国家/省份/城市:" prop="ctData" @change='creatLsCust("postForm")' class="postInfoleft">
                        <template>
                          <el-cascader disabled clearable change-on-select style="width:41%" @change='creatLsCust("postForm")' placeholder="" v-model="postForm.ctData" :options="seletData.ctDataOption"
                                       filterable>
                          </el-cascader>
                  ...
                  <el-row>
                    <el-col :span="12">
                      <el-form-item label="是否客户:" class="postInfo-container-item">
                        <span v-if="postForm.isCustomer==1">是</span>
                        <span v-if="postForm.isCustomer==0">否</span>
...
<!--                        </template>-->
                    ...
                    <el-col :span="12">
                      <el-form-item label="合作状态:" class="postInfo-container-item">
                        <!-- <template>
                          <el-select default-first-option :disabled="true" :clearable='true' placeholder="请选择" v-model="postForm.curStatus" filterable>
                            <el-option v-for="item in seletData.hzstatus" :key="item.id" :label="item.typeName" :value="String(item.id)">
                            </el-option>
                          </el-select>
                        </template> -->
                        {{ postForm.collaborationStatusStr }}
                      </el-form-item>
                    </el-col>
                  </el-row>
                  <el-row class="fullRow" v-if="postForm.collaborationStatus == 2251">
                    <el-col :span="24">
                      <el-form-item label="停用说明:" class="postInfo-container-item">
                        {{postForm.collaborationStatusDesc}}
                      </el-form-item>
                    </el-col>
                  </el-row>
                  <el-row class="fullRow">
                  ...
                  <el-row class="">
                    <el-col :span="12">
                      <el-form-item label="主体法律性质:" prop="legalNature" class="postInfo-container-item">
                        <template>
                          <el-select disabled default-first-option :clearable='true' placeholder="请选择" v-model="postForm.legalNature" @change='creatLsCust("postForm")' filterable>
                  ...
                  <el-row class="fullRow">
                    <el-col :span="24">
                      <el-form-item class="postInfo-container-item">
                        ...
                        <p v-for="item in postForm.materialList.filter(item => item.materialTypeId == 301656)">
                          <span  class="itemTitle_style"  @click="preview(item)">{{item.name}}</span>
...
<!--                        <el-input v-model="postForm.scale"></el-input>-->
                        {{postForm.scale}}
                      </el-form-item>
                    </el-col>
                    <el-col :span="12">
                  ...
                  <el-row class="fullRow">
                    <el-col :span="24">
                      <el-form-item label="简介:" class="postInfo-container-item textareaItem">
                        {{postForm.info}}
...
<!--                        </el-input>-->
                  ...
                  <el-row class="fullRow">
                    <el-col :span="24">
                      <el-form-item label="合作评价:" class="postInfo-container-item textareaItem">
                  ...
                  <el-row class="fullRow">
                    <el-form-item label="账期附件:" class="postInfo-container-item uploader-custfile">
                      <p v-for="item in postForm.materialList.filter(item => item.materialTypeId == 301655)">
                        <span  class="itemTitle_style"  @click="preview(item)">{{item.name}}</span>
                        <el-button type="text" class="el-icon-view" @click="preview(item)"></el-button>
                      </p>
                    </el-form-item>
                  ...
                  <el-row class="fullRow">
                    <el-col :span="24">
                      <el-form-item label="账期优惠/折扣:" class="postInfo-container-item">
                        {{postForm.accountPeriodDiscount}}
                      </el-form-item>
                    </el-col>
                  </el-row>
                  <el-row class="fullRow">
                  ...
                  <el-row class="fullRow">
                    <el-col :span="24">
                      ...
                      <el-form-item label="客户文档:" class="postInfo-container-item uploader-custfile">
                        <p v-for="item in postForm.materialList.filter(item => item.materialTypeId == 301625)">
                          <span  class="itemTitle_style"  @click="preview(item)">{{item.name}}</span>
                          <el-button type="text" class="el-icon-view" @click="preview(item)"></el-button>
                        </p>
<!--                        <template>-->
<!--                          <el-upload class="upload-demo" name="custFile" :data='addCustomerFileData' ref="uploadCustFile" :action="addCustomerFileUrl"-->
<!--                                     :before-upload="handlePreview"-->
<!--                                     :on-preview="preview"-->
<!--                                     list-type='picture' :before-remove="(file)=>brforeRemoveFile(file,'cust')" :file-list="postForm.materialList" :auto-upload="false">-->
...
<!--                    </el-table-column>-->
              ...
              <el-row>
                <el-col class="tilteSpan" style="padding-bottom: 0;" :span="24">
                  <span id='wflxr-title'>银行账户</span>
                </el-col>
              </el-row>
              <div style="margin-left: 10px;">
                <p v-for="item in postForm.materialList.filter(item => item.materialTypeId == 301657)">
                  <span  class="itemTitle_style"  @click="preview(item)">{{item.name}}</span>
                  <el-button type="text" class="el-icon-view" @click="preview(item)"></el-button>
                </p>
              </div>
              ...
              <el-row>
                <el-col :span="24">
                  <el-table size="mini" :data="postForm.customerOffercountriesList" border fit empty-text="暂无数据" highlight-current-row current-row-key style="width: 100%;">
                    ...
                    <el-table-column label="简介" align="left" width>
                      <template slot-scope="scope">
                        {{ scope.row.memo }}
                      </template>
                    </el-table-column>
...
<!--                    </el-button>-->
    ...
    <el-dialog :show-close="false" :close-on-click-modal="false" title="客户地址" :visible.sync="dialogFormAddr" width="70%">
    ...
    <el-dialog :show-close="false" :close-on-click-modal="false" title="对方联系人" @open='dialogFormOpen("dfcon")' :visible.sync="dialogFormdfcon" width="70%">
    ...
    <el-dialog :show-close="false" :close-on-click-modal="false" title="客户活动" :visible.sync="dialogFormhd" width="70%">
...
<!--                      </el-table-column>-->
    ...
    <el-dialog :show-close="false" :close-on-click-modal="false" title="银行账户" :visible.sync="dialogFormyhzh" width="70%">
    ...
    <el-dialog :show-close="false" :close-on-click-modal="false" title="客户指示" @open='dialogFormOpen("zs")' :visible.sync="dialogFormzs" width="70%">
  ...
  export default {
    ...
    data() {
      return {
        ...
        // select的获取id有对应文档查询
        seletDataArr:
          "1129,1042,1,1044,1053,1045,1076,1050,1049,1051,1052,1112,1063,1047,1046,5",
        seletData: {
          comLanguage: {}, //沟通语言
              ...
              if (response.success) {
                for (const v of this.postForm.activities) {
                  if (v.custActId === this.hdFromData.custActId) {
                    ...
                    this.postForm.activities.splice(index, 1, this.hdFromData);
