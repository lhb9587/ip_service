  ...
  export default {
    ...
    data(){
      return{
        ...
        tableTitleList: [
          {"title":"接收人","value":"userFullName" ,width:'90'}, { 'title': '接收人的邮箱', 'value': 'fromAddress',width:'200' },{"title":"发送时间","value":"createTime" ,width:'150'},
          {"title":"发送状态","value":"sendStart",width:'110' }],
      }
    },
    created(){
      this.init()
