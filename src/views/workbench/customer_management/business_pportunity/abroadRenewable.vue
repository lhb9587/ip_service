...
<!--            <img @click="exportList(2)" src="@/assets/moon.png" width="16" alt=""></div>-->
<!--        </div>-->
        <right-table ref="rightTable" v-if="visiable" type="境外续展提醒" :childDataList="childDataList"></right-table>
      </div>
    </el-dialog>
...
import { queryCustomerNameId, sendBusiness, getBusinessInternationalList, setBusiness } from '@/api/caseList'
...
export default {
  ...
  data(){
    return {
      ...
      tableTitleList: [
        ...
        {"title":"邮件主题","value":"emailTheme" },
        {"title":"可续展商标数量","value":"extensionTmNum" },
        {"title":"处于宽展期商标数量","value":"graceTmNum" },
        {title:'送达工作组',value: 'groupName'},
  ...
  methods:{
    ...
    getBusinessList(){
      getBusinessInternationalList(this.$commonUtils.cleanNullAttr(Object.assign(this.queryModuleData,this.listQuery))).then(res=>{
