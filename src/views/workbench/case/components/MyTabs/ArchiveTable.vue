<template>
  <div class="staff">
    ...
    <el-dialog :visible.sync="detailView" title="档案信息" width="50%" append-to-body :close-on-click-modal="false">
      <archiveDetail v-if="detailView" :check-type="checkType" :archive-id="archiveId" @closeDialog="closeDetailDialog"></archiveDetail>
    </el-dialog>

    <el-dialog :visible.sync="settingView" append-to-body :title="settingName" :close-on-click-modal="false">
...
import archiveDetail from '@/views/workbench/material_management/components/archiveDetail.vue';
import archiveSetting from '@/views/workbench/material_management/components/archiveSetting.vue';
