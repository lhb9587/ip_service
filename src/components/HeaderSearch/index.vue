        ...
        <el-button-group class="button-group-search">
          ...
          <transition name="show" mode="out-in">
            ...
            {{itmx}}
                    ...
                    <el-input clearable v-model="queryModuleData[item.property]" :placeholder="'请输入'+item.filterName" type="textarea" v-if="item.filterType==='textarea'" @keyup.enter.native.stop="() => {}"></el-input>
                    ...
                    <DateYearPicker class="DataPicker" v-if="item.filterType==='dateYear'"
                                v-model="queryModuleData[item.property]"></DateYearPicker>
