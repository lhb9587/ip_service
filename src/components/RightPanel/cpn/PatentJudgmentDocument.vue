  ...
  <div class="judgment-wrapper">
    <div class="left-detail" :style="{width: halfWidth}" v-if="detailView">
      <div class="detail-top">
        <div class="top-left" v-html="detailData.writName">
          <!--          {{ detailData.caseName }}-->
        </div>
        <div class="top-right">
        ...
        <div class="base-info">
          ...
          <div class="base-info-content">
            <div class="content-row" @mouseleave="copyText = '复制'">
              <div class="left-label">专利号:</div>
              <div class="right-text">
                <el-popover
                  placement="right"
                  trigger="hover"
                  popper-class="document-person-pop1"
                >
                  <div class="person">
                    <el-table
                      ref="tableList"
                      ...
                      :data="detailData.writPatentPersonList || []"
                      empty-text="暂无数据"
                    ...
                    >
                      ...
                      >
                        <template slot-scope="scope">
                          {{ formateDate(scope.row.invalidDay) }}
                        </template>
                      </el-table-column>
                      <el-table-column
                        align="left"
                      ...
                      >
                        <template slot-scope="scope">
                          {{ formateDate(scope.row.decisionDay) }}
                        </template>
                      </el-table-column>
                      <el-table-column
                        align="left"
                  ...
                  <div slot="reference" style="cursor: pointer;">{{detailData.patentNumber}}</div>
                </el-popover>
<!--                <div class="left-text" v-html="detailData.patentNumber">-->
<!--                  &lt;!&ndash;                  {{ detailData.court }}&ndash;&gt;-->
<!--                </div>-->
                <div class="copy" v-if="detailData.patentNumber">
                  <div class="copy-text">
                    <el-tag size="mini" type="" @click="copyTextFunc(detailData.patentNumber)">{{ copyText }}</el-tag>
                  </div>
                  <div class="copy-search">
                    <el-tag size="mini" type="" @click="relSearch(detailData.patentNumber, 'patentNumber', '专利号')">关联搜索
                    </el-tag>
                  </div>
                </div>
              </div>
            ...
            <div class="content-row" @mouseleave="copyText = '复制'">
              <div class="left-label">专利权人:</div>
              <div class="right-text">
                <div class="left-text" v-html="detailData.patentee">
                  <!--                  {{ detailData.caseNum }}-->
                </div>
                <div class="copy" v-if="detailData.patentee">
                  <div class="copy-text">
                    <el-tag size="mini" type="" @click="copyTextFunc(detailData.patentee)">{{ copyText }}</el-tag>
                  </div>
                  <div class="copy-search">
                    <el-tag size="mini" type="" @click="relSearch(detailData.patentee, 'currentApplicant', '专利权人')">关联搜索
                    </el-tag>
                  </div>
                </div>
              </div>
            ...
            <div class="content-row" @mouseleave="copyText = '复制'">
              ...
              <div class="right-text">
                ...
                <div class="copy" v-if="detailData.caseType">
                  ...
                  <div class="copy-search">
                    <el-tag size="mini" type="" @click="relSearch(detailData.caseType, 'caseType', '案件类型')">关联搜索
                    </el-tag>
                  </div>
                </div>
              </div>
            ...
            <div class="content-row" @mouseleave="copyText = '复制'">
              ...
              <div class="right-text">
                <div class="left-text" v-html="detailData.caseNumber">
                  <!--                  {{ detailData.caseNum }}-->
                </div>
                <div class="copy" v-if="detailData.caseNumber">
                  <div class="copy-text">
                    <el-tag size="mini" type="" @click="copyTextFunc(detailData.caseNumber)">{{ copyText }}</el-tag>
                  </div>
                  <div class="copy-search">
                    <el-tag size="mini" type="" @click="relSearch(detailData.caseNumber, 'caseNumber', '案号')">关联搜索
                    </el-tag>
                  </div>
                </div>
              </div>
            ...
            <div class="content-row" @mouseleave="copyText = '复制'">
              ...
              <div class="right-text">
                <div class="left-text" v-html="detailData.caseAction">
                  <!--                  {{ detailData.caseType }}-->
                </div>
                <div class="copy" v-if="detailData.caseAction">
                  <div class="copy-text">
                    <el-tag size="mini" type="" @click="copyTextFunc(detailData.caseAction)">{{ copyText }}</el-tag>
                  </div>
                  <div class="copy-search">
                    <el-tag size="mini" type="" @click="relSearch(detailData.caseAction, 'caseAction', '案由')">
                      关联搜索
                    </el-tag>
                  </div>
                </div>
...
<!--                  &lt;!&ndash;                  {{ detailData.hearingProcedure }}&ndash;&gt;-->
<!--                </div>-->
...
<!--            </div>-->
            <div class="content-row" @mouseleave="copyText = '复制'">
              ...
              <div class="right-text">
                <div class="left-text" v-html="formateDate(detailData.adjudicationDate || '')">
                  <!--                  {{ detailData.adjudicationDate }}-->
                </div>
                <div class="copy" v-if="formateDate(detailData.adjudicationDate)">
                  <div class="copy-text">
                    <el-tag size="mini" type="" @click="copyTextFunc(formateDate(detailData.adjudicationDate))">{{ copyText }}
                    </el-tag>
                  </div>
<!--                  <div class="copy-search">-->
<!--                    <el-tag size="mini" type=""-->
...
<!--                  </div>-->
            ...
            <div class="content-row" @mouseleave="copyText = '复制'">
              <div class="left-label">发布日期:</div>
              <div class="right-text">
                <div class="left-text" v-html="formateDate(detailData.releaseDate)">
                  <!--                  {{ detailData.openDate }}-->
                </div>
                <div class="copy" v-if="formateDate(detailData.releaseDate)">
                  <div class="copy-text">
                    <el-tag size="mini" type="" @click="copyTextFunc(formateDate(detailData.releaseDate))">{{ copyText }}</el-tag>
                  </div>
<!--                  <div class="copy-search">-->
<!--                    <el-tag size="mini" type="" @click="relSearch(detailData.releaseDate, 'openDateList', '公开日期')">-->
<!--                      关联搜索-->
<!--                    </el-tag>-->
<!--                  </div>-->
                </div>
...
<!--                  &lt;!&ndash;                  {{ detailData.caseReason }}&ndash;&gt;-->
<!--                </div>-->
...
<!--            &lt;!&ndash;            {{ detailData.legalBasis }}&ndash;&gt;-->
<!--          </div>-->
<!--        </div>-->
        <div class="result">
    ...
    <div class="judgment-document" :style="{width: halfWidth}">
      <div class="top-search-content">
        ...
        <span class="dialog-title">专利裁判文书搜索</span>
        ...
        <patent-search-content  ref="search" @search="searchEvent" />
...
<!--        </el-button>-->
      ...
      <div class="search-sum">
        ...
        <div class="search-info" style="display:flex;justify-content: space-between;align-items: flex-end">
...
<!--          </div>-->
          <div style="padding: 0 0 5px 0px">
            <el-tag size="mini" :type="searchType == 1 ? '' : 'info'" style="cursor: pointer;margin-right: 10px;" @click="changeSearchType(1)">民事+专利权权属</el-tag>
            <el-tag size="mini" :type="searchType == 2 ? '' : 'info'" style="cursor: pointer;margin-right: 10px;" @click="changeSearchType(2)">行政+专利行政管理</el-tag>
            <el-tag size="mini" :type="searchType == 3 ? '' : 'info'" style="cursor: pointer;margin-right: 10px;" @click="changeSearchType(3)">行政+国家知识产权局</el-tag>
          </div>
          <div class="sum">
      ...
      <div class="content-list"
        ...
        <div class="doc-content" v-for="(doc, index) in docList" :key="index" :class="{ 'highlighted': selectedDocId === doc.id }" @click="showDetail(doc)">
          ...
          <div class="title" :title="doc.writName" v-html="doc.writName">
            <!--            {{ doc.caseName }}-->
          </div>
          <div class="info">
<!--            <div class="iconfont " :class="doc.isFavorite ? 'icon-aixin1' : 'icon-aixin'"-->
<!--                 @click.stop="favoriteClick(doc)"></div>-->
            <div class="court" v-html="doc.caseNumber">
              <!--              {{ doc.court }}-->
            </div>
            <div class="no" v-html="doc.patentNumber">
              <!--              {{ doc.caseNum }}-->
            </div>
<!--            <div class="no">-->
<!--              {{ doc.caseType }}-->
<!--            </div>-->
            <div class="date">
              <span class="iconfont icon-susong"></span>
                            {{ formateDate(doc.adjudicationDate) }}
            </div>

            <div class="date" v-html="formateDate(doc.releaseDate)">
              <span class="iconfont icon-susong"></span>
...
<!--                &lt;!&ndash;                {{ doc.privyC }}&ndash;&gt;-->
<!--              </div>-->
<!--              <div slot="reference" class="iconfont icon-wj-rymc"></div>-->
<!--            </el-popover>-->
          </div>
          <div class="desc">
            <span style="margin-right: 30px;">{{doc.caseType}}</span>
            <span>{{doc.caseAction}}</span>
          </div>
        </div>
      </div>
      <pagination
...
import {
  queryDocumentSearch,
  queryDocumentSearchById, queryWritInfoById,
  queryWritInfoList,
  updateFavoriteByUserId
} from '@/api/docSearch'
import Pagination from "@/components/Pagination/index.vue";
import Search from "./Search.vue";
import PatentSearchContent from '@/components/RightPanel/cpn/PatentSearch.vue'

export default {
  name: "PatentJudgmentDocument",
  components: { PatentSearchContent, Search, Pagination},
  data() {
    return {
  ...
  computed: {
    ...
    result() {
      const content = this.detailData.writInfoContent && this.detailData.writInfoContent.content || ''
  ...
  methods: {
    ...
    showDetail(data) {
      if (this.selectedDocId === data.id) return
      this.selectedDocId = data.id
      queryWritInfoById({id: data.id}).then(res => {
